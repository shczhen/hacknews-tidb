...
Let's think step by step, use best practice of writing SQL, use common table expression if and only if necessary, generate only one SQL to answer this question: "(I want you think like a god)${question}"`;
  }
}
